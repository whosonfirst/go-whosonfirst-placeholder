module github.com/whosonfirst/go-whosonfirst-placeholder
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-iterate-organization/v2 v2.0.1
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-iterate-git/v2 v2.1.8 // indirect
